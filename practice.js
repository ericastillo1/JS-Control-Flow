...
function manageBts () {
 ...
 function whoCares () {
    let brushItOff= alert(" You brush it off and let him know that its just an accident. When he asks you to apologize, you let him know the coffee will just wash out, and that there's nothing to aploogize for. The members are taken back with how rude you are. There overall happiness falls 50%. \n \n H = 35% \n \n They do not want you as their manager, you are terminated immediately \n\n click `ok ` to restart game")
 ...
 function priceToPay () {
    let pay = alert("You inform them that their lifestyle involves them touring and traveling constantly, and that that is the price of fame. They are upset that you completely dismiss their feelings. Their happiness falls by 50%. \n \n H = 30% \n \n They do not want you as their manager, you are terminated immediately \n\n click `ok ` to restart game ")
 ...
 function cheerThemUp () {
    let cheer = alert("To cheet them up, you let them know that you will remove some tasks off their busy schedule so they can take that time to rest and talk with friends or family. They are appreciative to have such an understanding manager. There happiness increases by 20%. \n \n  H = 100% \n \n Congrats on being BTS's new manager !!! \n \n  click `ok ` to restart game")
 ...
 function munchies () {
    let snacks = alert("You inform the members that due to traffic, it will take awhile for the staff member to meet you all at the venue. And due to this, you asked the staff member to pick up some snacks on the way back. The members are thankful for the staff members generosity. You guys eventaully arrive to the stadium.\n \n  H = 100% \n \n Congrats on being BTS's new manager !!! \n \n  click `ok ` to restart game ")
 ...
 function rushing () {
    let hurry = alert("As you are on the phone with the staff member, you inform them to hurry back as soon as possible. You make it clear that if they are not back within a certain time, that their will be consequences. The members are in disbelief with how rude you are. Their happiness falls 50%. \n \n H = 50% \n \n They do not want you as their manager, you are terminated immediately \n\n click `ok ` to restart game ") 
